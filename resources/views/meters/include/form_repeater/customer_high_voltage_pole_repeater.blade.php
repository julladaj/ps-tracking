<div id="customer_high_voltage_pole_repeater">
    <div data-repeater-list="meter_extra_keys[customer_high_voltage_pole]">
        @forelse($meter->meter_extra_groups('customer_high_voltage_pole') as $data)
